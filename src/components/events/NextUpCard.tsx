...
export function NextUpCard({ events, t }: NextUpCardProps) {
  ...
  return (
    <div className="mb-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      >
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-azulejo-600 via-azulejo-700 to-azulejo-800 dark:from-azulejo-800 dark:via-azulejo-900 dark:to-azulejo-950 p-5 shadow-lg shadow-azulejo-500/20 hover:shadow-xl transition-all">
          {/* Background pattern */}
          ...
          {/* Decorative blur */}
          <div className="absolute -right-4 -top-4 w-20 h-20 rounded-full bg-azulejo-500/20 blur-xl" />
