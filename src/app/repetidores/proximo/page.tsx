...
export default function NearestRepeaterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-azulejo-50/50 via-background to-background dark:from-azulejo-950/30 dark:via-background dark:to-background">
